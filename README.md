...
- Provide your risk calculations related to the findings that you find using the OWASP Risk Calculator or CVSS and it would be even better if you include MITRE ATT&CK ID's
